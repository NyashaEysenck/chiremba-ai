...
export default function Navbar() {
  ...
  return (
    <nav className="bg-transparent fixed w-full z-20 top-3 left-0">
      <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4 border-2 border-white/20 rounded-full backdrop-blur-sm">
        {/* Logo */}
        <Link
          href="/"
        ...
        <div className="hidden md:flex space-x-12 rtl:space-x-reverse text-xl font-bold">
          <Link
            href="/"
            className="text-xl text-slate-300 hover:text-blue-400 font-semibold"
          >
            Home
          </Link>
          <Link
        ...
        <div className="flex items-center space-x-4 rtl:space-x-reverse">
          {isLoggedIn ? (
            ...
            <div className="relative">
              ...
              />
              {isDropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg shadow-lg">
